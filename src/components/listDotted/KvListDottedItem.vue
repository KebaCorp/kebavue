<template>
  <kv-flex-item class="list-dotted-item">
    <kv-flex class="list-dotted-item-flex">

      <!--Left-->
      <kv-flex-item class="list-dotted-item-left">
      ...
      <!--Right-->
      <kv-flex-item class="list-dotted-item-right">
...
<style lang="scss" scoped>
  .list-dotted-item, .list-dotted-item-flex, .list-dotted-item-left {
    background: inherit;
  }

  .list-dotted-item-left-item {
    position: relative;
    background: inherit;
    z-index: 1;
    padding-right: 5px;
  ...
  .list-dotted-item-left {
    position: relative;
  }

  .list-dotted-item-left::after {
    content: "";
    position: absolute;
    left: 0;
    right: 0;
